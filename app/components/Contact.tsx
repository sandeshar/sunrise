...
const Contact = () => {
    return (
        <div>
            ...
            <div className="grid grid-cols-2 justify-center items-center gap-10 p-12" >
                <div>
                    <p className="font-bold text-4xl flex justify-center items-center gap-2"><FaCheckCircle /> We'll respond to you in an hour.</p>
                    <p className="text-xl text-gray-400 mt-5 text-center">Have questions, ideas or projects in mind? We'd love to hear from you! Contact us through our email or phone number provided below and let's start a conversation.</p>
                </div>
